'''
This program prints the efficient robots recognised by the paper titled "A Statistical Analysis of Commercial Articulated 
Industrial Robots and Cobots" that satisfy the input specification ranges a user provides.
The CSV files containing data of Fanuc, Kuka, ABB, Yaskawa and Universal Robots should be in the root directory of the current 
Python file.
